...
from .schedulers import schedule, compute_utility, TW_POLICIES, theta_now, theta_arrival, \
    predicted_arrival_age, tw_info
...
def run(cfg: SimConfig, precomputed=None, collect_graph: bool = False,
        collect_tx: bool = False, iexact_fraction: float = 1.0) -> RunResult:
    """Run one session.
